    ...
    <CommonLayout>
      ...
      <Box mb={3}>
        ...
        <StyledContent>
          ...
          cả thằng JVM ở trên) luôn, tiện lợi.
        </StyledContent>{' '}
        <StyledContent>
          Mình sẽ đính kèm link để các bạn có thể tải xuống.Trong series này mình sẽ tập trung vào
          Windows OS, sau đó bạn chọn phiên bản x64 Installer và tiến hành cài đặt như bình thường.
        </StyledContent>
        <StyledContent>
      ...
      <Box mb={3}>
        ...
        <StyledContent>
          ...
          bản cao cấp thì IDE cung cấp tất tần tật các chức năng siêu cấp vippro, ở đây chúng ta sẽ
          sử dụng Intellij IDEA, với 2 phiên bản : Community (Free) và Ultimate (Trả phí hoặc miễn
          phí- với những bạn có email dạng “.edu ”).{' '}
        </StyledContent>
        <StyledContent>
