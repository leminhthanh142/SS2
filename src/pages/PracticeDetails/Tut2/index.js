...
const code = `public class GCD {
  public static void main (String[] args) {
    int result = compute(30, 12);
...
export const PracticePageDetails2 = () => {
  const { id } = useParams();
  ...
  const handleUnlockSolution = () => {
    navigate(`/practices/2/solutions`);
  };
            ...
            <QuestionCardDetails
              ...
              description={
                <Typography>
                  ...
                  large, so you need to find a clever solution. <br />
                  The inputs <code>x</code> and <code>y</code> are always greater or equal to 1, so
                  the greatest common divisor will always be an integer that is also greater or
                  equal to 1.
                </Typography>
              }
            />
